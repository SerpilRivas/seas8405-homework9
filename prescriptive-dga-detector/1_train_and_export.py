...
LEGIT_SEEDS = [
    "google.com","wikipedia.org","openai.com","h2o.ai","gwu.edu","python.org",
    "microsoft.com","apple.com","github.com","cloudflare.com","reddit.com",
    "nytimes.com","washingtonpost.com","bbc.co.uk","nasa.gov","who.int",
]
...
def main():
    ...
    try:
        ...
        aml = H2OAutoML(max_runtime_secs=args.runtime_secs, seed=args.seed,
                        balance_classes=True, sort_metric="AUC")
